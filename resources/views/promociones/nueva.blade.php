...
<div id="tab-nueva" class="tab-pane fade in active">
    ...
    <div class="tab-content">
        ...
        <div id="tab-usuario" class="tab-pane fade in active">
            {{Form::open(array('id'=>'form-promo-usuario'))}}
            ...
            <div class="form-group col-xs-12 col-md-6" id="form-grouplimite">
                {{Form::checkbox('limiteChk', '1', false)}}
                {{Form::label('Límite de usos')}}
                {{Form::number('limiteNum', '', array('class'=>'form-control', 'disabled'=>'disabled'))}}
            </div>
                            ...
                            <div class="form-group col-xs-12 col-md-8 col-md-offset-2" id="form-group-descuento-precio">
                               <div class="input-group">
                                   ...
                                   <span class="input-group-addon">$</span>
                                    {{Form::number('descuentoPrecioInput', 0, array('class'=>'form-control', 'min'=>'0', 'max'=>'1000000'))}}
                                </div>
                            </div>
                            <div class="form-group col-xs-12 col-md-8 hide" id="form-group-descuento-porcentaje">
                                <div class="input-group">

                                    {{Form::number('descuentoPorcInput', 0, array('class'=>'form-control', 'min'=>'0', 'max'=>'100'))}}
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="productos-container">
                                <div class="producto-item">
                                    <div class="form-group col-xs-12" id="form-group-producto">
                                        ...
                                        {{Form::text('producto', '', array('id'=>'producto1', 'class' => 'form-control'))}}
                                        {{Form::hidden('producto_id', '', array('id'=>'producto_id'))}}
                                    </div>
                                    <div class="col-xs-12 producto-hidden">
                                        <div class="form-group col-xs-12" id="form-group-descuento">
                                            {{Form::radio('descuentoRadio1', 'descuentoPrecio', true)}}
                                            {{Form::label('descuentoPrecio1', 'Descuento en precio  &nbsp;&nbsp;')}}
                                            {{Form::radio('descuentoRadio1', 'descuentoPorcentaje')}}
                                        ...
                                        <div class="form-group col-xs-12 col-md-8" id="form-group-descuento-precio">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon">$</span>
                                                {{Form::number('descuentoPrecioInput1', 0, array('class'=>'form-control', 'min'=>'0', 'max'=>'1000000'))}}
                                            </div>
                                        </div>
                                        <div class="form-group col-xs-12 col-md-8 hide" id="form-group-descuento-porcentaje">
                                            <div class="input-group">

                                                {{Form::number('descuentoPorcInput1', 0, array('class'=>'form-control', 'min'=>'0', 'max'=>'100'))}}
                                                <span class="input-group-addon">%</span>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div id="tab-producto" class="tab-pane fade in">
            {{Form::open(array('id'=>'form-promo-producto'))}}
            <div class="form-group col-xs-12" id="form-group-producto">
                {{Form::label('producto', 'Producto')}}
                {{Form::text('producto', '', array('id'=>'producto1', 'class' => 'form-control'))}}
                {{Form::hidden('producto_id', '', array('id'=>'producto_id'))}}
        ...
        <div id="tab-general" class="tab-pane fade in">
            {{Form::open(array('id'=>'form-promo-general'))}}
