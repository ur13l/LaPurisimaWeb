...
<body bgcolor="#E1E1E1" leftmargin="0" marginwidth="0" topmargin=
"0" marginheight="0" offset="0">
<!-- CENTER THE EMAIL // -->
<!--
...
<center style="background-color:#E1E1E1;">
  ...
  <tr>
    ...
    width="500" id="emailHeader"><!-- HEADER ROW // -->
    <tr>
              ...
              <tr>
                <td valign="top" width="500" class="flexibleContainerCell">
                  ...
                  <tr><!--
                    ...
                    is visible.
                  -->
                  <td align="left" valign="middle" id="invisibleIntroduction" class=
                  "flexibleContainerBox" style=
              ...
              <td align="right" valign="middle" class="flexibleContainerBox">
                ...
                <tr>
                  <td align="left" class="textContent"><!-- CONTENT // -->
                    <div style=
                    "font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                    Si no puedes ver este mensaje, <a href="#" target="_blank" style=
                    "text-decoration:none;border-bottom:1px solid #828282;color:#828282;">
                    <span style=
                    "color:#828282;">ábrelo&nbsp;en&nbsp;tu&nbsp;navegador</span></a>.</div>
                  </td>
                </tr>
              </table>
            </td>
...
<tr>
  ...
  <tr>
    <td align="center" valign="top"><!-- FLEXIBLE CONTAINER // -->
      ...
      Most content tables within can then beLef
    ...
    <table border="0" cellpadding="20" cellspacing="0" width="100%">
      <tr>
        <td  valign="top" class="textContent" style="height:50px; min-height:40px;">
          <div style="display:inline-block; width:75%">
            <h1 style=
            "color:#FFFFFF;font-family:Helvetica,Arial,sans-serif;display:inline;font-size:22px;font-weight:normal;margin-bottom:5px;text-align:center;">
            La Purísima</h1><br>
            <h2 style=
            "text-align:center;font-weight:normal;display:inline;font-family:Helvetica,Arial,sans-serif;font-size:14px;margin-bottom:10px;color:#205478;line-height:135%;">
            Recuperación de contraseña</h2>
          </div>
          <div style="display:inline-block; width:14%">
              <img style="display:inline-block; position:relative; top:0; right:0" width="64" src="{{url('img/logo-lapurisima.png')}}" alt="" />
          </div>
  ...
  <td align="center" valign="top"><!-- CENTERING TABLE // -->
    ...
    <tr>
      <td align="center" valign="top"><!-- FLEXIBLE CONTAINER // -->
        ...
        class="flexibleContainer">
        <tr>
          <td align="center" valign="top" width="500" class=
              ...
              <td align="center" valign="top"><!-- CONTENT TABLE // -->
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    ...
                    -->
                    <h3 mc:edit="header" style=
                    "color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">
                    Hola {{$user->nombre}},</h3>
                    <div mc:edit="body" style=
                    "text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                    Recientemente has solicitado un cambio de contraseña de tu cuenta
                    de La Purísima, da click en el botón mostrado abajo para restaurarla.
                    </div>
                  </td>
                </tr>
              </table>
      ...
      <tr style="padding-top:0;">
        <td align="center" valign="top"><!-- FLEXIBLE CONTAINER // -->
          ...
          <tr>
            ...
            class="flexibleContainerCell"><!-- CONTENT TABLE // -->
            <table border="0" cellpadding="0" cellspacing="0" width="50%"
            class="emailButton" style="background-color: #3498DB;">
            <tr>
              <td align="center" valign="middle" class="buttonContent" style=
              "padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
              <a style=
              "color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:16px;line-height:135%;"
              href="{{ $link = url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset()) }}" target="_blank">Recuperar contraseña</a></td>
            </tr>
          </table>
          <!-- // CONTENT TABLE --></td>
        </tr>
              ...
              <td align="center" valign="top"><!-- CONTENT TABLE // -->
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    ...
                    <div mc:edit="body" style=
                    "text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;font-weight:bold;">
                    Gracias.
                    </div>
                  </td>
                </tr>
...
-->
<table bgcolor="#E1E1E1" border="0" cellpadding="0" cellspacing="0"
width="500" id="emailFooter"><!-- FOOTER ROW // -->
<!--
To move or duplicate any of the design patterns
in this email, simply move or copy the entire
MODULE ROW section for each content block.
            ...
            <table border="0" cellpadding="30" cellspacing="0" width="100%">
              <tr>
                <td valign="top" bgcolor="#E1E1E1">
                  <div style=
                  "font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                  <div>Copyright © 2016 <a href=
                    "http://www.charlesmudy.com/respmail/" target="_blank" style=
                    "text-decoration:none;color:#828282;"><span style=
                    "color:#828282;">La Purísima</span></a>.
